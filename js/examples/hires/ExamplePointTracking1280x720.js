if(nxtjs == null) {
	throw "ExamplePointTracking1280x720.js needs a fully initialized Beyond Reality Face Nxt SDK. Make sure to follow the implementation examples of the JS version of the SDK.";
}
if(nxtjs.ExamplePointTracking == null) {
	throw "ExamplePointTracking1280x720.js uses ExamplePointTracking as base class. Make sure to follow the implementation examples of the JS version of the SDK.";
}
if(createjs == null) {
	throw "ExamplePointTracking1280x720.js uses CreateJS to display its content. Make sure to follow the implementation examples of the JS version of the SDK.";
}
...
function initExample() {
	...
	_stage.addChild(new nxtjs.ExamplePointTracking1280x720());
}

(function(lib) {

	/**
	 * This subclass of ExamplePointTracking shows how to set custom resolutions.
	 * 
	 ...
	 */
	(lib.ExamplePointTracking1280x720 = function() {

		var _this = this;
		var _super = lib.ExamplePointTracking1280x720._super;
...
//		);
	...
	}).inheritsFrom(lib.ExamplePointTracking);
