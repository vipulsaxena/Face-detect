if(nxtjs == null) {
	throw "ExampleFaceDetection1280x720.js needs a fully initialized Beyond Reality Face Nxt SDK. Make sure to follow the implementation examples of the JS version of the SDK.";
}
if(nxtjs.ExampleFaceDetection == null) {
	throw "ExampleFaceDetection1280x720.js uses ExampleFaceDetection as base class. Make sure to follow the implementation examples of the JS version of the SDK.";
}
if(createjs == null) {
	throw "ExampleFaceDetection1280x720.js uses CreateJS to display its content. Make sure to follow the implementation examples of the JS version of the SDK.";
}
...
function initExample() {
	...
	_stage.addChild(new nxtjs.ExampleFaceDetection1280x720());
}

(function(lib) {

	/**
	 * This subclass of ExampleFaceDetection shows how to set custom resolutions.
	 * 
	 * We want to use a 720p camera resolution and also show that 720p video on screen,
	 * but BRF will operate on a 640x480 BitmapData and limit the area it
	 * uses from that image to an even smaller chunk to raise performance.
	 * 
	 ...
	 */
	(lib.ExampleFaceDetection1280x720 = function() {

		var _this = this;
		var _super = lib.ExampleFaceDetection1280x720._super;
...
//		);
	...
	}).inheritsFrom(lib.ExampleFaceDetection);
