if(nxtjs == null) {
	throw "ExampleFaceTracking1280x720.js needs a fully initialized Beyond Reality Face Nxt SDK. Make sure to follow the implementation examples of the JS version of the SDK.";
}
if(nxtjs.ExampleFaceTracking == null) {
	throw "ExampleFaceTracking1280x720.js uses ExampleFaceTracking as base class. Make sure to follow the implementation examples of the JS version of the SDK.";
}
if(createjs == null) {
	throw "ExampleFaceTracking1280x720.js uses CreateJS to display its content. Make sure to follow the implementation examples of the JS version of the SDK.";
}
...
function initExample() {
	...
	_stage.addChild(new nxtjs.ExampleFaceTracking1280x720());
}
...
(function(lib) {
	 ...
	 */
	(lib.ExampleFaceTracking1280x720 = function() {

		var _this = this;
		var _super = lib.ExampleFaceTracking1280x720._super;
